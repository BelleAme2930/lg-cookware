...
const SaleForm = ({sale, customers, products, accounts}) => {

    const formattedProducts = sale?.items ? formatExistingItems(sale.items) : [];
    ...
    const {data, setData, errors, processing, post, patch, reset} = useForm({
        ...
        notes: sale?.notes ?? '',
        products: sale?.items ? formatExistingItems(sale.items) : [],
        payments: sale?.payments ? formatExistingPayments(sale.payments) : [],
            ...
            <form onSubmit={handleSubmit}>
                <div className='mb-4'>
                    <InputSelect
                        ...
                        onChange={(option) => {
                            setData('customer', option ? option.value : '');
                            setData('products', []);
                ...
                <div className='mb-4'>
                    ...
                    <Textarea
                        ...
                        placeholder="Enter sale notes (optional)"
                        className="w-full"
                    />
                </div>
                            ...
                            {data.payments.length > 0 && (
                                <div className='flex justify-between p-3 bg-gray-100 rounded-md mt-2'>
                                    ...
                                    <div className='text-right'>
                                        <div>Total Sale: {calculateTotalAmount().toLocaleString()} Rs.</div>
